...
def touch(gr1, gr2, coeff=1.0, error='None', projected=0):
   ...
   if gr1.mDist <0.001 or gr2.mDist <0.001:
     ...
     if v1<0: v1=100
     if v2<0: v2=100
     if abs(v1-v2) > 0.23*min(v1,v2):
        return False
    
   if gr1.mDist >0.001 and gr2.mDist >0.001:
     v1 = gr1.Vls
     v2 = gr2.Vls
     if v1<0: v1=100
     if v2<0: v2=100
...
if __name__ == '__main__':
   ...
   ## added by Brent:
   ##In the case of NGC3241, this galaxy probably belongs in the NGC3223 (PGC1+ = 30308) supergroup.  (Antlia Cluster).
   force_add(SuperList, GroupList, SGID=30308 , obj_id=30498) 
   ...
   force_add(SuperList, GroupList, SGID=5974 , obj_id=5072711)
   remove_obj(SuperList, GroupList, 5072710, gal=True)
   remove_obj(SuperList, GroupList, 5072714, gal=True)
   remove_obj(SuperList, GroupList, 5072715, gal=True)
   ...
   SGroupwrite(cluster+'.iter.2.v44.supergroup.tmp', SuperList, GroupList)
