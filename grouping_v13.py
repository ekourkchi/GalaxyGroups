...
if __name__ == '__main__':
  ...
  if cluster == 'virgo':
    inFile  = 'AllSky.north.v16.csv'
  elif cluster == 'virgo_w':
    inFile  = 'AllSky.north.v16.csv'
  elif cluster == 'fornax':
    inFile  = 'AllSky.south.v16.csv'
  elif cluster == 'north':
    inFile  = 'AllSky.north.v16.csv'
  elif cluster == 'south':
    inFile  = 'AllSky.south.v16.csv'   
...
####################################################################
	...
	for qp in range(0,2):
	  mergGroup(G_list, restrict=True)    
        ...
        if cluster == 'north':
          groupWrite('north.iter.'+str(int(iter))+'.v30.group', G_list, galList)
        elif cluster == 'south':
	  groupWrite('south.iter.'+str(int(iter))+'.v30.group', G_list, galList)
        elif cluster == 'manual':
	  groupWrite('manual.iter.'+str(int(iter))+'.v30.group', G_list, galList)
