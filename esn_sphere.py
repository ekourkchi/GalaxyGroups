...
########################################################################## 
def draw_patch_poly( map, ax, lons, lats, color='blue'):
...
if __name__ == '__main__':
 ...
 for lon in np.arange(8,360.,1.):
  ...
  #if cluster == 'north' :
  map = Basemap(projection='ortho',lat_0=60.,lon_0=lon,resolution='h', ax=ax)   # for the current Virgo view log=280
  #if cluster == 'south' :
    #map = Basemap(projection='spstere',boundinglat=-10,lon_0=90,resolution='h', ax=ax)

  ## draw parallels and meridians.
  paral = map.drawparallels(np.arange(-80.,90.,20.))
  merid = map.drawmeridians(np.arange(0.,360.,30.))
  ...
  #Y=[80,90]
  #X, Y = map(X,Y)
  #point, = ax.plot(X, Y, ':', markersize = 4, color='black')
  
  #X=[90,90]
  #Y=[80,90]
  #X, Y = map(X,Y)
  #point, = ax.plot(X, Y, ':', markersize = 4, color='red')
  
  

  
  
  #meridian = np.arange(0,360,20)
  #for i in np.arange(len(meridian)):
    #ax.annotate(np.str(int(meridian[i])),xy=map(meridian[i],-20),xycoords='data')
################################################################ 
  ...
  #x, y = map( 280, 0 )
  #ax.annotate(r'$GB=0^o$', (x,y), size=12, color='black')
  #x, y = map( 280, 20 )
  #ax.annotate(r'$20^o$', (x,y), size=12, color='black')
  #x, y = map( 280, 40 )
  #ax.annotate(r'$40^o$', (x,y), size=12, color='black')
  #x, y = map( 280, 60 )
  #ax.annotate(r'$60^o$', (x,y), size=12, color='black')  
  #x, y = map( 280, 80 )
  #ax.annotate(r'$80^o$', (x,y), size=12, color='black')   
  #map.drawmeridians(np.arange(280,281.,20.), color='g')
  
  

  
  
  #ax2.annotate(r'$GL=0^o$', (0.650,0.430), size=12, color='black')
  #ax2.annotate(r'$20^o$', (0.649,0.598), size=12, color='black')
  #ax2.annotate(r'$40^o$', (0.602,0.742), size=12, color='black')
  #ax2.annotate(r'$60^o$', (0.529,0.844), size=12, color='black')
  #ax2.annotate(r'$80^o$', (0.446,0.904), size=12, color='black')
  #ax2.annotate(r'$100^o$', (0.350,0.922), size=12, color='black')
  
  #ax2.annotate(r'$120^o$', (0.249,0.899), size=12, color='black')
  #ax2.annotate(r'$140^o$', (0.1639,0.839), size=12, color='black')
  #ax2.annotate(r'$160^o$', (0.094,0.739), size=12, color='black')
  #ax2.annotate(r'$180^o$', (0.047,0.596), size=12, color='black')
  #ax2.annotate(r'$200^o$', (0.037,0.434), size=12, color='black')
  
  #ax2.annotate(r'$220^o$', (0.077,0.272), size=12, color='black')
  #ax2.annotate(r'$240^o$', (0.148,0.154), size=12, color='black')
  #ax2.annotate(r'$260^o$', (0.232,0.090), size=12, color='black')
  #ax2.annotate(r'$280^o$', (0.346,0.064), size=12, color='black')
  #ax2.annotate(r'$300^o$', (0.453,0.090), size=12, color='black')
  
  #ax2.annotate(r'$320^o$', (0.543,0.161), size=12, color='black')
  #ax2.annotate(r'$340^o$', (0.613,0.275), size=12, color='black')
...
##########################################################################
  ...
  #GL_vertex = [280, 280, 300, 300]
  #GB_vertex = [-40, 20, 20, -40]
  #draw_patch_poly(map, ax, GL_vertex, GB_vertex)
  
  #print map( GL_vertex, GB_vertex )
  ...
  if True :
    for i in range(len(GB)):
      ...
      if GL[i]>=0 and GL[i]<90 and GB[i]>-40 and GB[i]<90:
        draw_patch_poly(map, ax, GL_vertex, GB_vertex, color=colorVal)
...
##########################################################################
  ...
  plt.savefig('movie/'+str(10000+int(lon))+'.png', dpi=100)  # the best view and size happens in eps format
  #plt.show()
