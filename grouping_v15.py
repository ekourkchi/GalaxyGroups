...
if __name__ == '__main__':
  ...
  ignore_list = [41618, 40001, 42447, 40240, 40851, 3085, 70090]   # April 18, 2016 (added pgc3085 SMC)
...
####################################################################
	...
	for qp in range(0,2):
	  mergGroup(G_list, restrict=True)    
        ...
        if cluster == 'north':
          groupWrite('north.iter.'+str(int(iter))+'.v32.group', G_list, galList)
        elif cluster == 'south':
	  groupWrite('south.iter.'+str(int(iter))+'.v32.group', G_list, galList)
        elif cluster == 'manual':
	  groupWrite('manual.iter.'+str(int(iter))+'.v32.group', G_list, galList)
